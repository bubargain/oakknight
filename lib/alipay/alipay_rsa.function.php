...
function rsaVerify($data, $ali_public_key_path, $sign)  {
    ...
    $result = (bool)openssl_verify($data, $res, base64_decode($sign));
    
    //var_dump($data,base64_decode($sign),$result);
    openssl_free_key($res);    
    return $result;
}
