...
;(function($){
	...
	$.fn.touchEventBind = function(touch_options)
	{
		var touchSettings = $.extend({
			tapDurationThreshold : 250,					//è§¦å±å¤§äºŽè¿™ä¸ªæ—¶é—´ä¸å½“ä½œtap
			scrollSupressionThreshold : 10,				//è§¦å‘touchmoveçš„æ•æ„Ÿåº¦
			swipeDurationThreshold : 250,				//å¤§äºŽè¿™ä¸ªæ—¶é—´ä¸å½“ä½œswipe
			horizontalDistanceThreshold: 130,			//swipeçš„è§¦å‘åž‚ç›´æ–¹å‘moveå¿…é¡»å°äºŽè¿™ä¸ªè·ç¦»
			verticalDistanceThreshold: 15,				//swipeçš„è§¦å‘æ°´å¹³æ–¹å‘moveå¿…é¡»å¤§äºŽè¿™ä¸ªè·ç¦»
			tapHoldDurationThreshold: 750,				//swipeçš„è§¦å‘æ°´å¹³æ–¹å‘moveå¿…é¡»å¤§äºŽè¿™ä¸ªè·ç¦»
			doubleTapInterval: 250						//swipeçš„è§¦å‘æ°´å¹³æ–¹å‘moveå¿…é¡»å¤§äºŽè¿™ä¸ªè·ç¦»
		}, touch_options || {})
...
function alertMSG(txt){
	var element = $("#alertMsg").css('display','-webkit-box;').html(txt).show();
	setTimeout(function(){
		element.hide();
	},1000)
}
